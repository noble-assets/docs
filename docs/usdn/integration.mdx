...
2. [Contact us](https://www.noble.xyz/#contact) to specify where the yield should be sent. This could be a smart contract, multisig, DAO treasury, or any other address.
...
#### Supported Network Types:
  ...
  - Custom integrations available for other networks. [Contact our team](https://www.noble.xyz/#contact) for a custom solution based on your network's state machine and canonical bridge.
